  ...
  return (
    <div className={cn("relative w-full sm:w-[255px]", wrapperClassName)}>
      ...
      <input
        type="search"
        className={cn(
          "w-full rounded-[4px] border border-[#141433] bg-[#25254D] pl-9 pr-3 font-normal text-[#DDD] placeholder:text-[#BEBECE]/60 focus-visible:border-[#2596FF] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2596FF]/25",
