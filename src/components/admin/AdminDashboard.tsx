...
interface SummaryStat { label: string; value: number; icon?: React.ReactNode; trend?: string; }
interface AdminStatus { rolesVirtual: boolean; usersFallback: boolean; usersSource: "legacy" | "directus" | "unknown"; }
