...
import { AdminShopFeature } from '@/features/admin/shop';
import { AdminThemeFeature } from '@/features/admin/theme';
...
export default function AdminDashboardFeature(props: AdminDashboardFeatureProps) {
...
function buildCockpitData(props: AdminDashboardFeatureProps, shop: ShopSummary) {
